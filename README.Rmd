...
> **Warning**
> Don't rely on current functionality for important scripts yet. It is very likely that ggplot2 changes their implementation of guides in the release *after* 3.4.0. At that point, the current functionality will cease to work.
